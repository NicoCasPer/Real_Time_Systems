...
#define INTEGRATED_LED_GPIO     GPIO_NUM_2      // LED interno del ESP32
...
#define INTEGRATED_LED_TASK_PERIOD_MS 1000
...
#define INTEGRATED_LED_TASK_STACK_SIZE     3072
#define INTEGRATED_LED_TASK_PRIORITY       5
